...
class RecipeManager:
    ...
    def search_for_recipe(self, name=None, partial=None):
        ...
        if name is not None and isinstance(partial, bool):
            return self.__search_for_recipe(name, partial)
        else:
            return self.__pre_search()
